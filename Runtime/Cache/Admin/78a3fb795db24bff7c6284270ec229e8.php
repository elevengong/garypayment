        ...
        <div class="col-md-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <blockquote class="layui-elem-quote" style="font-size:14px;padding;8px;">报告生成时间：<?php echo date('Y-m-d H:i:s');?>&nbsp;&nbsp;&nbsp;&nbsp;截止目前 平台总利润：<?php echo ($platform_profit_all); ?>元</blockquote>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <!--<td>
                                    <button class="layui-btn layui-btn-small layui-btn-danger"
                                            onclick="money_incr('冲正','<?php echo U('User/incrMoney',['uid'=>$vo[memberid]-10000, 'date'=>$date]);?>',640,480)">
                                        冲正</button>
                                </td> -->
...
<script>
    ...
    $('#export').on('click',function(){
        window.location.href
            ="<?php echo U('Admin/Statistics/exportPlatform',array('memberid'=>$_GET[memberid],'date'=>$date));?>";
    });
