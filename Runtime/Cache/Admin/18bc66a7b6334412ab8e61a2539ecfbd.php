            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td>
                ...
                <?php if(($vo["pay_status"]) != "0"): if($vo['lock_status']==1): ?><button class="layui-btn layui-btn-small layui-btn-normal">订单冻结中</button><?php endif; endif; ?>
                    ...
                    <?php if(($vo["pay_status"]) != "0"): if($vo['lock_status']==0): ?><button class="layui-btn layui-btn-small layui-btn-normal" onclick="forzenOrder(this,'<?php echo ($vo["id"]); ?>')">冻结订单</button><?php endif; ?>
