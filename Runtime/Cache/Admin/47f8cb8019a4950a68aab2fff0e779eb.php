...
<script>
    ...
    $('#export').on('click',function(){
        window.location.href
            ="<?php echo U('Admin/Statistics/exportAgent',array('memberid'=>$_GET[memberid],'date'=>$date));?>";
    });
</script>
</body>
</html>