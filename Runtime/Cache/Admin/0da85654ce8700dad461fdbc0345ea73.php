...
<div class="ibox-title">
    <h5>支付通道【<?php echo ($data["name"]); ?>】交易统计&nbsp;&nbsp; <button style="float:left;margin-right: 10px;margin-top:18px;" class="layui-btn layui-btn-normal layui-btn-mini" type="button" onclick="window.history.back(-1);" title="返回" ><i class="layui-icon"></i></button></h5>
    ...
    <div class="row">
        <?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="col-sm-4">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                  <h5 style="width: 100%;"><?php echo ($v["title"]); ?>-<?php echo ($v["code"]); ?>   <a href="<?php echo U('Admin/Statistics/channelAccountFinance',['id'=>$v[id]]);?>" style="float:right;color:red;">子账号统计</a></h5>
                </div>
